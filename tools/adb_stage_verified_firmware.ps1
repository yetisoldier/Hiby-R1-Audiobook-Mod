param(
    ...
    [Parameter(Mandatory=$false)]
    [string]$Package = "work\audiobook-firmware-1.6.16.6-audiobook\r1-audiobooks-1.6.16.6-audiobook.upt",
    ...
    [Parameter(Mandatory=$false)]
    [string]$ExpectedVersion = "1.6.16.6-audiobook",

    [Parameter(Mandatory=$false)]
    [string]$ExpectedLabel = "HiBy R1 Audiobook FW 1.6.16.6",
