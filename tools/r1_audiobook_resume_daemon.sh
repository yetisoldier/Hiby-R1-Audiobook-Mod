...
BOOK_TITLE_DIRECT_OPEN_ENABLED=${AUDIOBOOK_BOOK_TITLE_DIRECT_OPEN_ENABLED:-0}
...
ARM_WINDOW_MS=${AUDIOBOOK_ARM_WINDOW_MS:-1000}
ARM_POLL_MS=${AUDIOBOOK_ARM_POLL_MS:-200}
