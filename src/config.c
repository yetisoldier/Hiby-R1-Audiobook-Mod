...
static const config_field FIELDS[] = {
    ...
    FIELD("AUDIOBOOK_SMART_REWIND_ENABLED",                 "SMART_REWIND_ENABLED",                 CFG_BOOL, smart_rewind_enabled,                 0, 1),
    FIELD("AUDIOBOOK_REWIND_SHORT_MS",                      "REWIND_SHORT_MS",                      CFG_U32, rewind_short_ms,                      0, 600000),
    FIELD("AUDIOBOOK_REWIND_MEDIUM_MS",                     "REWIND_MEDIUM_MS",                     CFG_U32, rewind_medium_ms,                     0, 600000),
    FIELD("AUDIOBOOK_REWIND_LONG_MS",                       "REWIND_LONG_MS",                       CFG_U32, rewind_long_ms,                       0, 600000),
...
static void set_defaults(daemon_config *c) {
    ...
    c->smart_rewind_enabled                   = 1;
    c->rewind_short_ms                        = 5000;
    c->rewind_medium_ms                       = 10000;
    c->rewind_long_ms                         = 20000;
...
void config_print_help(void) {
    fprintf(stderr,
        ...
        "  AUDIOBOOK_SMART_REWIND_ENABLED  Enable smart rewind tiers (default: 1)\n"
